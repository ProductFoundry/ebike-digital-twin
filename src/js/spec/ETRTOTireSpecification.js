  ...
  function ETRTOTireSpecification() {
    ...
    xhttp.onreadystatechange = (obj) => {
      if (obj.currentTarget.readyState == 4 && obj.currentTarget.status == 200) {
        this.specs = JSON.parse(xhttp.responseText).tires;
      }
    };
    xhttp.open("GET", "https://api.jsonstorage.net/v1/json/f3dd63ab-aad8-4608-9dbc-df9f7a5b050f/05366cd9-963e-4692-bee7-d11a1384f381", false);
    xhttp.send();
  }
